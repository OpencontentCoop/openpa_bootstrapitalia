...
[datatype_view_bando_cpv_link_as_button]
Source=content/datatype/view/ezurl.tpl
MatchFile=datatype/view/url_as_button.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=cpv_link
...
############################################
############################################ BANDO CIG - ANAC IMPORTED FIELDS
############################################

[datatype_edit_bando_anac_oggetto]
Source=content/datatype/edit/ezstring.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=oggetto

[datatype_edit_bando_anac_published]
Source=content/datatype/edit/ezdate.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=published

[datatype_edit_bando_anac_anno]
...
[datatype_edit_bando_anac_location]
Source=content/datatype/edit/ezurl.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=location

[datatype_edit_bando_anac_cpv_link]
Source=content/datatype/edit/ezurl.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
...
[datatype_edit_bando_anac_extra_info]
Source=content/datatype/edit/ezmatrix.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
...
[datatype_edit_bando_anac_tender_types]
Source=content/datatype/edit/eztags.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=tender_types

[datatype_edit_bando_anac_tender_result_types]
Source=content/datatype/edit/eztags.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=tender_result_types

[datatype_edit_bando_anac_tender_status_types]
Source=content/datatype/edit/eztags.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=tender_status_types

[datatype_edit_bando_anac_tender_contract_types]
Source=content/datatype/edit/eztags.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=tender_contract_types

[datatype_edit_bando_anac_contract_value]
Source=content/datatype/edit/ezprice.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=contract_value

[datatype_edit_bando_anac_award_value]
Source=content/datatype/edit/ezmatrix.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=award_value

[datatype_edit_bando_anac_award_winners]
Source=content/datatype/edit/ezmatrix.tpl
MatchFile=content/datatype/edit/bando_anac_imported_field.tpl
Subdir=templates
Match[class_identifier]=bando
Match[attribute_identifier]=award_winners
