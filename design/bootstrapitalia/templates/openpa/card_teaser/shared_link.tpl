<div data-object_id="{$node.contentobject_id}" class="shared_link-card_teaser card card-teaser shadow {$node|access_style} rounded {$view_variation}">
    <div class="card-body">
        ...
        <div class="card-text">
            <p class="mt-3">
                <a data-shared_link="{$node.contentobject_id}" data-shared_link_view="card_teaser" target="_blank" href="{$openpa.content_link.full_link}" title="{'Go to content'|i18n('bootstrapitalia')} {$node.name|wash()}">
