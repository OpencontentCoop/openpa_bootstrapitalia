...
<div data-object_id="{$node.contentobject_id}" class="card card-teaser shadow {$node|access_style} rounded {if $view_variation|ne('card-teaser-info')}border{/if} {$view_variation}">
