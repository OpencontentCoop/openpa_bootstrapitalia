...
<div class="global-view-full mb-3">

    <h1 class="h3 pt-3">Impostazioni SEO e Cookie consent</h1>
    ...
    <form method="post" action="{'openpa/seo'|ezurl(no)}" class="form Form Form--spaced">
        <div class="form-group Form-field--choose block checkbox">
            <label class="p-0 font-weight-bold Form-label--block" for="robots">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group block m-0">
                    <label class="p-0 font-weight-bold" for="webAnalyticsItaliaId">Codice Web Analytics Italia</label>
                ...
                <div class="form-group block m-0">
                    <label class="p-0 font-weight-normal Form-label--block" for="webAnalyticsItaliaCookieless">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group block m-0">
                    <label class="p-0 font-weight-bold" for="webAnalyticsItaliaSiteId">Site Id WAI (per la pagina statistiche)</label>
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-normal Form-label--block" for="googleCookieless">
            ...
            <div class="col-md-4">
                <div class="alert alert-info">
                    Il codice Site Id WAI è reperibile nella pagina di amministrazione di Web Analytics Italia
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group block m-0">
                    <label class="p-0 font-weight-bold Form-label--block" for="cookieConsentMultimedia">
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-normal " for="cookieConsentMultimediaText">Personalizza il testo degli strumenti dei cookie di terze parti</label>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="googleTagManagerId">Codice Google Tag Manager</label>
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="googleSiteVerificationID">Codice Google Site Verification (richiesto per utilizzare la Google Search Console)</label>
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="RobotsText">Contenuto robots.txt {if $isRobotsTextDefault}(default){/if}</label>
                    <textarea id="RobotsText" class="form-control border box" rows="10" type="text" name="RobotsText">{$robotsText|wash()}</textarea>
                </div>

                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="metaAuthor">Meta Author</label>
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="metaCopyright">Meta Copyright</label>
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="metaDescription">Meta Description</label>
                ...
                <div class="form-group block">
                    <label class="p-0 font-weight-bold" for="metaKeywords">Meta Keywords</label>
