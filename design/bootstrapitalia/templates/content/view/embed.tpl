...
{if and( $object.main_node_id|null|not, $object.can_read )}
    {node_view_gui content_node=$object.main_node view=card_teaser show_icon=$show_icon image_class=$image_class view_variation=$view_variation hide_title=$hide_title}
{/if}
