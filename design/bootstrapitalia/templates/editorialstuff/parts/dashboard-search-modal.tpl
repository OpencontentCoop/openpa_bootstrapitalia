    ...
    <div class="modal-dialog" role="search">
        <div class="modal-content">
            <div class="modal-body mt-5">
                <form method="get" data-query="{$base_query|wash(javascript)}">
                    <div class="search-gui container position-relative">
                        ...
                        <div style="position: fixed;top: 15px;z-index: 100;left:0;width: 100%">
                            <div class="container text-right">
                                <button class="do-search btn btn-outline-primary btn-icon btn-sm mt-3 bg-white" type="submit">{'Confirm'|i18n('editorialstuff/dashboard')}</button>
                            </div>
                        </div>
                                    ...
                                    <div class="offset-lg-1 col-lg-10 offset-md-1 col-md-10 col-sm-12">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 mb-4">
                                                <div class="it-datepicker-wrapper">
                                                    <div class="form-group">
                                                        <label for="datepicker_start">{'Start date'|i18n('editorialstuff/dashboard')}</label>
                                            ...
                                            <div class="col-md-6 col-sm-12 mb-4">
                                                <div class="it-datepicker-wrapper">
                                                    <div class="form-group">
                                                        <label for="datepicker_end">{'End date'|i18n('editorialstuff/dashboard')}</label>
