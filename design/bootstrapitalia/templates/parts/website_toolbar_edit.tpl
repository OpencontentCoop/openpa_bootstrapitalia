...
<nav class="toolbar edit-toolbar" id="ezwt">
    <ul class="d-flex flex-nowrap">
        ...
        <li class="publish-buttons">
            ...
            <input class="btn btn-xs btn-warning" type="submit" name="StoreExitButton" value="{'Store draft and exit'|i18n( 'design/standard/content/edit' )}" title="{'Store the draft that is being edited and exit from edit mode. Use when you need to exit your work and return later to continue.'|i18n( 'design/standard/content/edit' )}" />
            <input class="btn btn-xs btn-dark" type="submit" name="DiscardButton" value="{'Discard draft'|i18n( 'design/standard/content/edit' )}" onclick="return window.confirmDiscard ? confirmDiscard( '{'Are you sure you want to discard the draft?'|i18n( 'design/standard/content/edit' )|wash(javascript)}' ): true;" title="{'Discard the draft that is being edited. This will also remove the translations that belong to the draft (if any).'|i18n( 'design/standard/content/edit' ) }" />
        </li>
