...
{if $count|gt($min_view_accordion)}
    <div id="opening-hours-title-{$object.id}" class="py-1">
        <a href="#opening-hours-{$object.id}" class="text-decoration-none opening-hours-accordion" data-toggle="collapse" data-bs-toggle="collapse" data-target="#opening-hours-{$object.id}" data-bs-target="#opening-hours-{$object.id}" aria-controls="opening-hours-{$object.id}">
