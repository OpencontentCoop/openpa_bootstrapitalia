{def $images = array()
     $exclude_first = false()}
{if and(is_set($view_context), $view_context|eq('full_attributes'), class_extra_parameters($attribute.object.class_identifier, 'table_view').main_image|contains($attribute.contentclass_attribute_identifier))}
