...
<div class="help-view">
    <div id="tabs" class="tabs">
        <ul>
            ...
            <li class="tab" style="display: none!important;"><span><a href="JavaScript:void(0);">{'Plugins'|i18n('design/standard/ezoe')}</a></span></li>
            <li class="tab" style="display: none!important;"><span><a href="JavaScript:void(0);">{'About'|i18n('design/standard/ezoe')}</a></span></li>
        </ul>
    </div>
