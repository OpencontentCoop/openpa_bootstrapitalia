...
<div class="panel_wrapper">
    <div class="panel current">
        <div class="attribute-title">
            ...
            {if and($tag_name_alias|eq('literal'), ezini_hasvariable( 'HTML', 'CustomAttributeNames', 'block.ini' ))}
                <h3 style="padding: 0 0 4px 0;">{ezini( 'HTML', 'CustomAttributeNames', 'block.ini' ).html|wash()}</h3>
            {/if}
        </div>
