...
<tr>
    ...
    <th class="id">{'ID'|i18n( 'design/admin/node/view/full' )}</th>
    <th class="name">{'Name'|i18n( 'design/admin/node/view/full' )}</th>
    <th class="remote_id">{'Remote ID'|i18n( 'design/admin/node/view/full' )}</th>
    <th class="class">{'Type'|i18n( 'design/admin/node/view/full' )}</th>
    <th class="owner">{'Owner'|i18n( 'design/admin/node/view/full' )}</th>
...
<td>
    {$node.contentobject_id|wash()}
</td>
<td>
    <a href={$node.url_alias|ezurl()}>{$node.name|wash()}</a>
</td>
<td>
    {$node.object.remote_id|wash()}
</td>
<td class="class">
