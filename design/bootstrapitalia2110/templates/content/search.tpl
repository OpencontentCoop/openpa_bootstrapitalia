        ...
        <aside class="col-lg-3">
            <div class="d-lg-block d-xl-block collapse mt-5" id="categoryCollapse">
                ...
                <fieldset class="mb-4">
                    ...
                    {foreach $top_menu_node_ids as $id}
                        ...
                        <div class="form-check custom-control custom-checkbox mb-3">
                            ...
                            {if $has_children}
                            <a class="float-end" aria-label="{'Expand section'|i18n('bootstrapitalia')}" href="#more-subtree-{$tree_menu.item.node_id}" data-toggle="collapse" data-bs-toggle="collapse" aria-expanded="false" aria-controls="more-subtree-{$tree_menu.item.node_id}" role="button">
                ...
                <fieldset class="mb-4">
                        ...
                        {if $count|lt($total)}
                            <a href="#more-topics" aria-label="{'Expand section'|i18n('bootstrapitalia')}" data-toggle="collapse" data-bs-toggle="collapse" aria-expanded="false" aria-controls="more-topics" role="button">
