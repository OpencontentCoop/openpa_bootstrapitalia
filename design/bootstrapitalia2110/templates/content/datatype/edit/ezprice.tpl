...
<div class="block">
    ...
    <div class="input-group mb-3">
        ...
        <div>
            ...
            <label class="d-none" for="ezcoa-{if ne( $attribute_base, 'ContentObjectAttribute' )}{$attribute_base}-{/if}{$attribute.contentclassattribute_id}_{$attribute.contentclass_attribute_identifier}_price">{'Price'|i18n( 'design/standard/class/datatype' )}:</label>
        </div>
    </div>
...
<div class="row mt-4 d-none">
    <div class="col-4">
        ...
        <select id="ezcoa-{if ne( $attribute_base, 'ContentObjectAttribute' )}{$attribute_base}-{/if}{$attribute.contentclassattribute_id}_{$attribute.contentclass_attribute_identifier}_vat"
                class="ezcc-{$attribute.object.content_class.identifier} ezcca-{$attribute.object.content_class.identifier}_{$attribute.contentclass_attribute_identifier}" name="{$attribute_base}_ezprice_inc_ex_vat_{$attribute.id}">
