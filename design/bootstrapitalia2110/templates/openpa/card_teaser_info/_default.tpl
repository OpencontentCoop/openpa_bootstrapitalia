...
<div data-object_id="{$node.contentobject_id}"
     class="font-sans-serif card card-teaser card-teaser-info rounded shadow-sm p-3 {if $view_variation|eq('auto_width')|not()}card-teaser-info-width {/if}mt-0 mb-3 {$view_variation}" style="z-index: {100|sub($attribute_index)}">
    {if $has_image}
