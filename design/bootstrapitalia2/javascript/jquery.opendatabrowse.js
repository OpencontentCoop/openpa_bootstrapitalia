            ...
            if (typeof $.fn.alpaca != 'undefined') {
                ...
                if (self.settings.addEditButton) {
                    ...
                    edit.bind('click', function (e) {
                        ...
                        var closePreviewButton = $('<a class="btn btn-xs btn-link pull-right" style="position: absolute;right: 10px;top: 10px;" href="#"><span class="glyphicon glyphicon-remove"></span></a>');
                        closePreviewButton.bind('click', function (e) {
                            self.browserContainer.show();
                            previewOuter.remove();
                            e.preventDefault();
