...
<div class="block-bg bg-primary" {if $background_image}{include name="bg" uri='design:atoms/background-image.tpl' url=$background_image}{/if}></div>
	<div class="container">
			...
			<div class="col-lg-10 col-xl-6 offset-lg-1 offset-xl-2">
				<div class="row">
					...
					<div class="col-lg-9 argomenti">
						...
						<div class="chip chip-simple chip-primary pb-0 mb-2">
