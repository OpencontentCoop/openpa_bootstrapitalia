{if count($block.valid_nodes)|gt(0)}
    ...
    <div class="{$valid_node|access_style}">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1 order-1 order-lg-2 px-0 px-lg-2 d-lg-flex align-items-stretch flex-nowrap">
                {if $has_video}
                ...
                {elseif $has_image}
                    <div class="flex-lg-fill bg-dark" style="background-image:url('{include uri='design:atoms/image_url.tpl' node=$valid_node}'); background-position: center center;background-repeat: no-repeat;background-size: cover;min-height:484px">
                        <img src="{include uri='design:atoms/image_url.tpl' node=$valid_node}"
