...
<div class="d-flex flex-wrap gap-2 mt-10 mb-30 font-sans-serif">
        ...
        <div class="cmp-tag">
                <a class="chip chip-simple chip-primary bg-tag text-decoration-none" href="{$child.url_alias|ezurl(no)}"{if $data_element} data-element="{$data_element|wash()}"{/if} data-focus-mouse="false">
