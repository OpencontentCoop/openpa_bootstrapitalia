...
<p data-element="legal-notes-body" class="mb-2">
    ...
    informazioni pubblicati sul sito sono rilasciati con <a href="https://creativecommons.org/licenses/by/4.0/legalcode.it">licenza CC-BY 4.0</a>.
</p>
<p data-element="legal-notes-body" class="mb-2">
    ...
    qualsiasi fine, anche commerciale con il solo onere di attribuzione, senza apporre restrizioni aggiuntive
</p>
