...
<div class="attribute-header">
    <h1 class="h2"><a class="text-decoration-none" href={$node.url_alias|ezurl}>{$node_name|wash}</a>
        <small>{'Sub items [%children_count]'|i18n( 'design/standard/websitetoolbar/sort',, hash( '%children_count', $children_count ) )}</small>
    </h1>
</div>
...
<div class="block">
    ...
    {if and( $priority_sorting, $node_can_edit, $children_count )}
        <input id="ezwt-update-priority" class="button" type="submit" name="LockedUpdatePriorityButton" value="{'Update priorities'|i18n( 'design/standard/websitetoolbar/sort' )}" title="{'Apply changes to the priorities of the items in the list above.'|i18n( 'design/standard/websitetoolbar/sort' )}" />
    ...
    {else}
        <input id="ezwt-update-priority" class="button-disabled" type="submit" name="LockedUpdatePriorityButton" value="{'Update priorities'|i18n( 'design/standard/websitetoolbar/sort' )}" title="{'You cannot update the priorities because you do not have permission to edit the current item or because a non-priority sorting method is used.'|i18n( 'design/standard/websitetoolbar/sort' )}" disabled="disabled" />
