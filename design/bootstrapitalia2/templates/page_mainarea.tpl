                        ...
                        <div class="card-body pb-5">
                            <div class="category-top">
                                <svg class="icon icon-sm" aria-hidden="true">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-calendar"></use>
                                </svg>
                                <span class="title-xsmall-semi-bold fw-semibold">Notizie</span>
                                <span class="data fw-normal">18 mag 2022</span>
                            </div>
                            <a href="#" class="text-decoration-none">
                                <h3 class="h4 card-title title-xlarge">Parte l'estate con oltre 300 eventi in centro e
                                    nei quartieri</h3>
                            </a>
                            <p class="mb-4 subtitle-small pt-3 lora"><strong>Inaugurazione lunedì 2 luglio</strong> con
                                il concerto
                                gratuito in
                                piazza XX Settembre degli Sweet Soul Music Revue. Sul palco 20 musicisti dal tutto il
                                mondo</p>
                            ...
                            <a class="read-more pb-3" href="#">
                                ...
                                <svg class="icon">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-arrow-right"></use>
                                </svg>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card-wrapper px-0 card-overlapping card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3">
                        ...
                        <div class="card card-teaser no-after rounded shadow-sm mb-0 border border-light">
                            <div class="card-body pb-5">
                                ...
                                <p class="text-paragraph-card u-grey-light m-0">La giunta, nominata dal sindaco,
                                    esercita collegialmente
                                    le funzioni ad essa
                        ...
                        <div class="card card-teaser no-after rounded shadow-sm mb-0 border border-light">
                            <div class="card-body pb-5">
                                ...
                                <p class="text-paragraph-card u-grey-light m-0">Il Consiglio è un organo collegiale ed
                                    elettivo che
                                        ...
                                        <div class="card-wrapper h-100">
                                            <div class="card card-bg">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text px-2 pb-10 mb-10"><a href="#">Presentazione
                                                            mostra
                                                            “Mediterraneo”</a></p>
                                                    <p class="card-text px-2 pb-10 mb-10 d-flex">
                                                        <img src="https://picsum.photos/200" alt="random image"
                                        ...
                                        <div class="card-wrapper h-100">
                                            <div class="card card-bg">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text px-2 pb-10 mb-10"><a href="#">Evento ”La notte
                                                            bianca
                                                            dei bambini”</a>
                                                    </p>
    ...
    <section class="evidence-section">
        <div class="section py-5 pb-lg-80 px-lg-5 position-relative"
             style="background-image: url({'images/assets/evidenza-header.png'|ezdesign( 'no' )})">
            <div class="container">
                <div class="row">
                    ...
                    <div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3">
                        <div class="card card-teaser no-after rounded shadow-sm border border-light">
                            <div class="card-body pb-5">
                                ...
                                <p class="card-text pb-3">Informazioni sui servizi di trasporto pubblico e servizi
                                    taxi</p>
                                ...
                                <a href="#" class="card card-teaser card-bg-blue no-after rounded mt-0 p-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-sans-serif text-white">Il sito del turismo del Comune e
                                            della Città
                                            Metropolitana.
                                        </p>
                                    </div>
                        ...
                        <div class="card card-teaser no-after rounded shadow-sm border border-light">
                            <div class="card-body pb-5">
                                ...
                                <p class="card-text">Informazioni sui servizi e le norme previste dal comune per gli
                                    animali domestici.
                                </p>
                      ...
                      <svg class="icon">
                        ...
                        <div class="card card-teaser no-after rounded shadow-sm border border-light">
                            <div class="card-body pb-5">
                                ...
                                <p class="card-text">Tutto quello che c’è da sapere sulle strutture sportive comunali a
                                    disposizione del
                                    pubblico e delle Associazioni, le iniziative a sostegno dello sport e gli eventi che
                                    coinvolgono la
                                    città. </p>
                                <div class="link-list-wrapper mt-4">
                                    <ul class="link-list" role="list">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="cmp-input-search">
                            <div class="form-group autocomplete-wrapper mb-2 mb-lg-4">
                                <div class="input-group">
                                    <label for="autocomplete-autocomplete-three" class="visually-hidden">Cerca una
                                        parola chiave</label>
                                    <input type="search" class="autocomplete form-control"
                                           placeholder="Cerca una parola chiave" id="autocomplete-autocomplete-three"
                        ...
                        <svg class="icon icon-sm icon-primary">
                          <use href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-search"></use>
                        </svg>
                      </span>
                                </div>
                            </div>
                        ...
                        <div class="card shadow card-wrapper" data-element="feedback">
                            <div class="cmp-rating__card-first">
                                <div class="card-header border-0">
                                    <h2 class="title-medium-2-semi-bold mb-0">Quanto sono chiare le informazioni su
                                        questa pagina?</h2>
                                </div>
                                <div class="card-body">
                                    <fieldset class="rating">
                                        ...
                                        <label class="full rating-star active" for="star5a">
                                            <svg class="icon icon-sm" role="img" aria-labelledby="first-star"
                                                 viewBox="0 0 24 24" id="it-star-full"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-check m-0">
                                                                <div class="radio-body border-bottom border-light cmp-radio-list__item">
                                                                    ...
                                                                    <label for="radio-1" class="active">Le indicazioni
                                                                        erano chiare</label>
                                                                </div>
                                                                <div class="radio-body border-bottom border-light cmp-radio-list__item">
                                                                    <input name="rating1" type="radio" id="radio-2">
                                                                    <label for="radio-2" class="active">Le indicazioni
                                                                        erano complete</label>
                                                                </div>
                                                                <div class="radio-body border-bottom border-light cmp-radio-list__item">
                                                                    <input name="rating1" type="radio" id="radio-3">
                                                                    <label for="radio-3" class="active">Capivo sempre
                                                                        che stavo procedendo correttamente</label>
                                                                </div>
                                                                <div class="radio-body border-bottom border-light cmp-radio-list__item">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-check m-0">
                                                                ...
                                                                <div class="radio-body border-bottom border-light cmp-radio-list__item">
                                                                    ...
                                                                    <label for="radio-7" class="active">A volte non
                                                                        capivo se stavo procedendo correttamente</label>
                                                                </div>
                                                                <div class="radio-body border-bottom border-light cmp-radio-list__item">
                                                                    <input name="rating2" type="radio" id="radio-8">
                                                                    <label for="radio-8" class="active">Ho avuto
                                                                        problemi tecnici</label>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                <ul class="contact-list p-0">
                                    <li><a class="list-item" href="#">
                                            <svg class="icon icon-primary icon-sm" aria-hidden="true">
                                                <use href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-help-circle"></use>
                                            </svg>
                                            <span>Leggi le domande frequenti</span></a></li>

                                    <li><a class="list-item" href="#" data-element="contacts">
                                            <svg class="icon icon-primary icon-sm" aria-hidden="true">
                                                <use href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-mail"></use>
                                            </svg>
                                            <span>Richiedi assistenza</span></a></li>

                                    <li><a class="list-item" href="#">
                                            <svg class="icon icon-primary icon-sm" aria-hidden="true">
                                                <use href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-hearing"></use>
                                            </svg>
                                            <span>Chiama il numero verde 05 0505</span></a></li>

                                    <li><a class="list-item" href="#" data-element="appointment-booking">
                                            <svg class="icon icon-primary icon-sm" aria-hidden="true">
                                                <use href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-calendar"></use>
                                            </svg>
                                ...
                                <ul class="contact-list p-0">
                                    <li><a class="list-item" href="#">
                                            <svg class="icon icon-primary icon-sm" aria-hidden="true">
                                                <use href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-map-marker-circle"></use>
                                            </svg>
                                            <span>Segnala disservizio </span></a></li>
                                </ul>
