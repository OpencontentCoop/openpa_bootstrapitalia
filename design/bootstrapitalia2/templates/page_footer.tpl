                    ...
                    <div class="it-brand-wrapper">
                        <a href="#">
                            <svg class="icon" aria-hidden="true">
                                <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-pa"></use>
                            </svg>
                ...
                <div class="col-md-3 mt-md-4 footer-items-wrapper">
                    ...
                    <ul class="list-inline text-start social">
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-twitter"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-facebook"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-youtube"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-telegram"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-whatsapp"></use>
                                </svg>
                        ...
                        <li class="list-inline-item">
                            <a class="p-1 text-white" href="#" target="_blank">
                                <svg class="icon icon-sm icon-white align-top">
                                    <use xlink:href="{'images/svg/sprites.svg'|ezdesign( 'no' )}#it-rss"></use>
                                </svg>
