            ...
            <div class="row">
                <div class="col-12 footer-items-wrapper logo-wrapper">
                    {if openpaini('GeneralSettings','ShowUeLogo', 'enabled')|eq('enabled')}
                        <img class="ue-logo lazyload" {if openpaini('ImageSettings', 'LazyLoadImages', 'disabled')|eq('enabled')}data-{/if}src="{'images/assets/logo-eu-inverted.svg'|ezdesign( 'no' )|shared_asset()}"
