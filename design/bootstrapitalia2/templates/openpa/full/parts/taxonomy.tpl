...
<section class="{$container_class}">
    ...
    {foreach array('has_public_event_typology', 'content_type', 'document_type', 'announcement_type', 'itinerary_type', 'itinerary_difficulty', 'tender_types', 'tender_result_types') as $identifier}
