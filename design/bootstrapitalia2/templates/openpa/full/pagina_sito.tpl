...
{def $first_block_has_bg = cond(and($has_layout, $blocks.first.color_style), true(), false())}
{def $last_block_has_bg = cond(and($has_layout, $blocks.last.color_style), true(), false())}
...
{node_view_gui content_node=$node view=children view_parameters=$view_parameters view_variation=cond($last_block_has_bg, 'py-5', 'pb-5')}
