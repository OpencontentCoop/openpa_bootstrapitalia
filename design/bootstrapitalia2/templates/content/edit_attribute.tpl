...
{def $edit_attribute_groups = edit_attribute_groups($class, $content_attributes, array('is_draft', 'codice_identificativo_gara', 'tender_types', 'tender_result_types', 'tender_status_types', 'status_note', 'has_code'))}
