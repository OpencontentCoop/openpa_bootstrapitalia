...
{if and( is_set( $class_content.class_constraint_list ),
         ...
         array('image', 'images', 'has_image')|contains($attribute.contentclass_attribute_identifier)|not()
)}

<div id="{concat('multiupload-', $attribute.id, '-container')}" class="d-inline-block ml-1 ms-1">
