                                    ...
                                    <div class="select-wrapper p-0 mt-1 select-partials">
                                        ...
                                        <select id="appointment-month" class="" data-focus-mouse="false">
                                            {foreach $months as $index => $month}
                                                <option {if $index|eq(0)}selected="selected"
                                                        {/if}value="{$month.index|wash()}">{$month.name|wash()}</option>
                                                {if $index|eq(1)}{break}{/if}
                                            {/foreach}
                                        </select>
                                    </div>
                                    <div class="select-wrapper p-0 mt-1 select-partials">
                                        <label for="appointment-day" class="visually-hidden">Seleziona un mese</label>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="single-line-info border-light">
                                                    ...
                                                    <div class="border-light">
                                                        <p class="data-text" data-placeOpening></p>
                                                    </div>
                                                </div>
                                            </div>
