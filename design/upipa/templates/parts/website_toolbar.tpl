    ...
    <nav class="toolbar" id="ezwt">
        <ul class="d-flex flex-nowrap border-bottom">
            ...
            {if or(
                ...
                fetch( 'user', 'has_access_to', hash( 'module', 'alboonline', 'function', 'use' ) )
            )}
            <li class="toolbar-divider" aria-hidden="true"></li>
            <li>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownToolbar">
                        <div class="link-list-wrapper">
                            <ul class="link-list">
                                ...
                                {/if}
                                {if fetch( 'user', 'has_access_to', hash( 'module', 'alboonline', 'function', 'use' ) )}
                                    <li>
                                        <a class="list-item left-icon" href="{'alboonline/dashboard'|ezurl(no)}">
                                            <i aria-hidden="true" class="fa fa-table"></i>
                                            Cruscotto Albo On Line
                                        </a>
                                    </li>
                                {/if}
                            </ul>
