...
<div class="section section-muted p-0 py-5 useful-links-section position-relative">
    <div class="block-bg h-100" {if $background_image}{include name="bg" uri='design:atoms/background-image.tpl' url=$background_image options="background-position: center"}{/if}></div>
