        ...
        const initSticky = isDesktop => {
            ...
            runCheckOnScroll = () => {
                ...
                const runCheckSticky = elSticky => {
                    ...
                    console.log(navOffsetTop, parentPaddingTop, navOffsetTop + parentPaddingTop);
                    ...
                    if (isSticky && isDesktop) {
                        if (
                            ...
                            elSticky.parentNode.style.zIndex = 0; //@todo
                        } else {
                            elSticky.classList.remove('at-bottom')
                            elSticky.parentNode.style.zIndex = 10; //@todo
                        }
                    }
                }
